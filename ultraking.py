...
if __name__ == "__main__":
    ...
    while True:
        # Obtention de l'image de la camera
        ...
        if extract:
            ...
            for k in range(num):
                ...
                rotationTmp = polygon.angleRotation+numpy.random.randn()*sigmaRot
                inclinaisonTmp = polygon.angleInclinaison+numpy.random.randn()*sigmaIncl
